...
# 记得引入你的模型类和数据集类
from sv_bst import CoLaVID, MultiModalNewsDataset, custom_collate_fn, feature_info, JSON_PATH, splits
import os
...
def clean_test(model_path, fixed_seq_len=32, fixed_dim=128, nhead=8, dropout=0.6, 
               conv_out=128, kernel_size=3, cls_hidden=56, cls_dropout=0.5, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dropout', type=float, default=0.6, help='Model parameter: dropout')
    parser.add_argument('--conv_out', type=int, default=128, help='Model parameter: conv_out')
    parser.add_argument('--kernel_size', type=int, default=3, help='Model parameter: kernel_size')
